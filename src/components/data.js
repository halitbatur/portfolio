const projects = [
  {
    name: "To-Doer",
    desc:
      "To-Doer is a collaboration tool that organizes your projectsinto boards, add items to each board and start working!",
    tech: ["Firebase", "Material-UI", "React"],
    github: "https://github.com/Halit-Batur/to-doers-0",
